...
public class  ImgUtil {
    ...
    static public int[] getInverse(int[] gray)
    {
    ...
    static public int[] guassBlur(int[] inverse, int width, int height)
    {
    ...
    static public int[] deceasecolorCompound(int[] guassBlur, int[] gray, int width, int height)
    {
        int a, b, temp;
        float ex;
    ...
    static public Bitmap create(int[] pixels , int[] output,int width , int height)
    {
    ...
    static public Bitmap createPencli(Bitmap bitmap)
    {
